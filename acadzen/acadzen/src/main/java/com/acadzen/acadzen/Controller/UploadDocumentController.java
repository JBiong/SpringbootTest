...
import com.acadzen.acadzen.Service.UploadDocumentService;
...
public class UploadDocumentController {
    ...
    @GetMapping("/files/{userno}")
    public ResponseEntity<List<UploadDocumentEntity>> getDocumentsByUser(@PathVariable int userno) {
